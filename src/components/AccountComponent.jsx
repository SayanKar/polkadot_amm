...
export default function AccountComponent(props) {
    ...
    const renderAccounts = () => {
        return (accountList.map( val => {
            return (
            <div className="accountWrapper" onClick={() => changeActiveAccount(val)}>
                <Identicon
                ...
                {   props?.activeAccount?.address ?
                    <>
                        <div className="accountDetail">
                            ...
                            <div className="changeActiveAccountIcon" onClick={() => onChangeShowTab("SelectAccount")}>
                        ...
                        <div className="Assets">
                            ...
                            <div className="assetBody">
                                <div className="row">
                                    ...
                                    <div className="attributeValue">{props.holding["amountOfKAR"]}</div>
                                </div>
                                <div className="row">
                                    <div className="attributeName">Amount of KOTHI</div>
                                    <div className="attributeValue">{props.holding["amountOfKOTHI"]}</div>
                                </div>
                                <div className="row">
                                    <div className="attributeName">Amount of Share</div>
                                    <div className="attributeValue">{props.holding["amountOfShare"]}</div>
                                </div>
                        ...
                        <div className="Assets">
                            ...
                            <div className="assetBody">
                                <div className="row">
                                    ...
                                    <div className="attributeValue">{props.holding["totalKAR"]}</div>
                                </div>
                                <div className="row">
                                    <div className="attributeName">Total KOTHI</div>
                                    <div className="attributeValue">{props.holding["totalKOTHI"]}</div>
                                </div>
                                <div className="row">
                                    <div className="attributeName">Total Share</div>
                                    <div className="attributeValue">{props.holding["totalShare"]}</div>
                                </div>
                    ...
                    :
                    <div className="accountConnectBtn" onClick={() => props.connect()}>Connect your wallet</div>
                }
                </>
            }
